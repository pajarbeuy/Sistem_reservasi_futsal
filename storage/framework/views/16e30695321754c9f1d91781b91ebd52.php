...
<body>
    ...
    <nav>
        <div class="nav-container">
            ...
            <div class="nav-buttons">
                <a href="<?php echo e(route('login')); ?>" class="nav-btn nav-btn-login">Masuk</a>
                <a href="<?php echo e(route('register')); ?>" class="nav-btn nav-btn-register">Daftar</a>
            </div>
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Booking Sekarang</a>
    ...
    <section class="cta">
        ...
        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary" style="background: white; color: #4CAF50;">Daftar Gratis Sekarang</a>
    </section>
...
<?php /**PATH D:\laragon\www\reservasi_futsal\resources\views/welcome.blade.php ENDPATH**/ ?>